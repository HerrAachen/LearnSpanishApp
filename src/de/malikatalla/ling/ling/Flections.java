...
public class Flections {
  ...
  public void addInflectedForm(Tense t, Person p, Number n, Gender g, String inflectedForm) {
    inflectedForms.put(new Flection(t, p, n, g), inflectedForm);
  }

  public String getInflectedForm(Tense t, Person p, Number n, Gender g) {
    String inflected = null;
    Flection f1 = new Flection(t, p, n, g);
